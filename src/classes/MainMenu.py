...
class MainMenu:
    def __init__(self, window, mouse, keyboard):
        ...
        self.playButton = src.classes.Button.Button(
            "./assets/images/play_button.png", 0, 0)
        self.difficultyButton = src.classes.Button.Button(
            "./assets/images/difficulty_button.png", 0, 0)
        self.rankingButton = src.classes.Button.Button(
            "./assets/images/ranking_button.png", 0, 0)
        self.exitButton = src.classes.Button.Button(
        ...
        self.difficultyButton.gameObject.x = (
            self.window.width / 2) - self.difficultyButton.gameObject.width / 2
        self.difficultyButton.gameObject.y = 300

        self.rankingButton.gameObject.x = (
            self.window.width / 2) - self.rankingButton.gameObject.width / 2
