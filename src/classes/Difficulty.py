...
class Difficulty:
    ...
    def __init__(self, window, mouse, keyboard):
        ...
        self.title = src.pplay.sprite.Sprite("./assets/images/difficulty_title.png")

        self.easyButton = src.classes.Button.Button("./assets/images/difficulty_easy.png", 0, 0)
        self.normalButton = src.classes.Button.Button("./assets/images/difficulty_normal.png", 0, 0)
        self.hardButton = src.classes.Button.Button("./assets/images/difficulty_hard.png", 0, 0)

        self.title.x = (self.window.width / 2) - self.title.width / 2
        self.title.y = 50

        self.easyButton.gameObject.x = (self.window.width / 2) - self.easyButton.gameObject.width / 2
        self.easyButton.gameObject.y = 200

        self.normalButton.gameObject.x = (self.window.width / 2) - self.normalButton.gameObject.width / 2
        self.normalButton.gameObject.y = 300

        self.hardButton.gameObject.x = (self.window.width / 2) - self.hardButton.gameObject.width / 2
